          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <span
              className={`px-3 py-1 rounded-full text-xs font-medium ${
                statusStyles[company.paymentStatus] ||
...
export default function RevenuePage() {
  ...
  const totalRevenue = companies
    ...
    .reduce(
      (sum, company) =>
        sum + parseRevenue(company.revenue),
      0
    );

  const pendingRevenue = companies
    .filter(
      (company) =>
        company.paymentStatus === "Pending"
    )
  ...
  const totalPages = Math.max(
    1,
    Math.ceil(
      companies.length / ROWS_PER_PAGE
    )
  );
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-7">
          ...
          <div>
            ...
            <p className="text-sm text-black mt-1">
              Track your platform revenue and payments
            </p>
          </div>
          ...
          <div className="p-5 border-b border-gray-200 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-black mt-1">
                Latest company payment activity
              </p>
            </div>
            ...
            <table className="w-full min-w-[800px] text-sm">
              ...
              <thead>
                <tr className="bg-gray-50 text-left">
                  ...
                  <th className="p-4 font-semibold text-black">
                    Company
                  </th>
                  ...
                  currentCompanies.map(
                    (company) => {
                      ...
                      return (
                        <tr
                          key={company.id}
                          className="border-t border-gray-100 hover:bg-[#a3feff]/10 transition"
                        >
