  ...
  return (
    <div className="w-full p-4 sm:p-6">
      <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-5 mb-8">
        <div>
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-800">Company Management</h2>
            ...
            >
              <div className="flex justify-between items-start gap-3">
                <div className="min-w-0">
                  ...
                  <p className="text-gray-500 mt-1 text-sm sm:text-base">{card.subTitle}</p>
                </div>
              ...
              <div className="mt-6 flex items-center justify-between">
                <span className={`${card.trendColor} font-semibold text-sm sm:text-base`}>
                  {card.trend}
                </span>
                <span className="text-xs sm:text-sm text-gray-400">vs Last Month</span>
              </div>
